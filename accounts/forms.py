...
from accounts.models import UserProfile, PaymentProofs, UserAccount
from ponzify.models import Plans
from django.contrib.auth.models import User
import fileinput
from django.core.exceptions import ValidationError
from Ponzi.settings import ALLOWED_SIGNUP_DOMAINS
...
class ProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = UserProfile
        fields = ('full_name', 'email', 'phone', 'picture')
...
class PasswordResetRequestForm(forms.Form):
    email_or_username = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}),
...
class UserAccountForm(forms.ModelForm):
    ...
    class Meta:
        model = UserAccount
        exclude = ('user', 'plan_type', 'confirm1', 'confirm2', )
